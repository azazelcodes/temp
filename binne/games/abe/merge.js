(function () {
  ...
  function updateLoadingDisplay() {
    ...
    const lines = [
      ...
      '<a style="font-size: 15px; color: #d42222; text-decoration: underline; margin-bottom: 10px; display: block;">gn-math</a>',
      '<a style="font-size: 15px; color: #14b4f3; text-decoration: underline; margin-bottom: 10px; display: block;">ugs</a>',
    ];
