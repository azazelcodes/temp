  ...
  try {
    ...
    _.m4 = class {
      ...
      play(a = 0, b = !1) {
        ...
        c.start(a, 0);
        const d = this.Ea++;
        this.Ba[String(d)] = { node: c, playTime: a * 1e3, lCc: b };
        return d;
      }
      stop(a) {
        JBz(this);
    ...
    _.n4 = class extends BBz {
      constructor(a, b, c, d = 314) {
        super("http://localhost:8000/providers/google/" + a + b + ".bin");
        this.index = c;
        this.Ba = d;
        this.oa = null;
        this.Ca = {};
  ...
  try {
    ...
    var oSz = new _.Il(15, 30),
      ...
      uSz = [
        ...
        { base: "#0070b4", target: "#808080", threshold: 10 },
      ],
      vSz = [
    ...
    var ISz = function (a) {
      ...
      MSz = function (a, b) {
        a.oz.src = `${"http://localhost:8000/providers/google/logos/fnbx/"}${a.path}`;
        _.on(a.oz, "load", () => {
          a.loaded = !0;
          b();
        });
    ...
    var oTz = function (a, b, c, d, e, f, g, h) {
        ...
        d = b.Dn ? c : 1;
        d5(a.settings, 11) &&
          (a.oa.globalAlpha = OSz(a.Eb, c, b.Si, { Esa: 0.3, N2: !1 }));
        if (Z4(a.settings))
          for (
        ...
        reset() {
          ...
          for (let a = 0; a < this.Aa.Aa.height; a++) {
            ...
            for (let b = 0; b < this.Aa.Aa.width; b++)
              this.oa[a].push({ direction: "NONE", Dn: !1, color: "", Si: !0 });
          }
        }
        refresh() {
          for (let a = 0; a < this.Aa.Aa.height; a++)
    ...
    var JTz = function (a, b, c) {
      ...
      STz = function (a, b, c, d = !1) {
        d = LTz(a, d);
        const e = a.oa.Da(d, 8);
        d && e && (RTz(a, { pos: d, prev: null, Dn: !0, Si: c }), JTz(a, e, b));
      },
      TTz = class {
        ...
        reset() {
          ...
          if (d5(this.settings, 9) && !d5(this.settings, 8)) {
            for (let a = 0; a + 1 < this.Ea.oa.length; a += 2) {
              ...
              this.Aa.add({ pos: b, prev: null, Dn: !1, Si: d });
              JTz(this, c, 0);
            }
            this.Ea.clear();
          }
    ...
    var XTz = function (a, b, c, d, e, f = !1) {
      ...
      YTz = function (a, b) {
        for (const e of a.Eb.Na.xda) {
          ...
          const h = e.Dn ? d : 1;
          d5(c.settings, 11) &&
            (c.Aa.globalAlpha = OSz(c.Eb, d, e.Si, { Esa: 0.3, N2: !1 }));
    ...
    var aUz = class {
      ...
      render(a) {
        for (const c of this.Eb.Ea.keys) {
          ...
          d5(this.settings, 11) &&
            (this.oa.globalAlpha = OSz(this.Eb, b, c.Si, { Esa: 0.3, N2: !1 }));
          this.oa.drawImage(
            this.Ca.aG(),
            128 * c.type,
            0,
    ...
    var eUz = function (a, b) {
        ...
        for (const h of a.Eb.La.Aa) {
          ...
          var g = d.Eb.oa.oa * 3;
          e = 1;
          d5(d.settings, 11) && (e = OSz(d.Eb, f, h.Si, { Esa: 0.3, N2: !1 }));
                  ...
                  : this.Eb.Aa.direction === "RIGHT"
                    ...
                    : this.Eb.Aa.direction === "UP"
                      ...
                      : this.Eb.Aa.direction === "DOWN" &&
                        ((Fc.y += 1),
                        Fc.y >= this.Eb.oa.Aa.height && (Fc.y = 0)))
      ...
      zUz = class {
        ...
        render(a, b) {
          ...
          for (const hc of g.Eb.La.Aa) {
            ...
            d5(k.settings, 11) &&
              (k.Aa.globalAlpha = OSz(k.Eb, m, hc.Si, { Esa: 0.3, N2: !1 }));
            const rc = (hc.QH + m) / 2,
              qd = Math.min(
                k.Ba.getLength() - 1,
          ...
          for (const hc of q.Eb.Na.xda)
            if (hc.active || hc.MIb) {
              ...
              d5(u.settings, 11) &&
                (u.oa.globalAlpha = OSz(u.Eb, qd, hc.Si, { Esa: 0.3, N2: !1 }));
    ...
    var Z4 = function (a) {
      ...
      EUz = function (a = 0) {
        ...
        return { ljb: a, vKa: c, cVb: d, OVb: e };
      },
      FUz = function (a) {
        let b = "c";
        ...
        if (d && e) {
          b =
            (a.settings.Ia === 22 && !d5(a.settings, 11)) || a.settings.Aa === 3
              ? LUz(a)
              : a.Aa.oa[b].vOa;
          QUz(a.Ba, e, { pos: e, Dn: !0, vOa: b, WQ: !1, Si: c });
          if (d5(a.settings, 7)) {
            const f = i5(a.oa, e);
            QUz(a.Ba, f, { pos: f, Dn: !1, WQ: !1, Si: c });
          }
          a.keys.push({
            pos: d.clone(),
            lZa: e.clone(),
        ...
        reset() {
          ...
          if (d5(this.settings, 8)) {
            for (let a = 0; a + 1 < this.Aa.oa.length; a += 2) {
              ...
              QUz(this.Ba, b, { pos: b, Dn: !1, vOa: d, WQ: !1, Si: e });
              if (d5(this.settings, 7)) {
                const f = i5(this.oa, b);
                QUz(this.Ba, f, { pos: f, Dn: !1, WQ: !1, Si: e });
              }
              this.keys.push({
                pos: c,
                lZa: b.clone(),
    ...
    var qUz = function (a) {
      ...
      dVz = function (a, b) {
        QUz(a, b, { pos: b, Dn: !0, WQ: !1, Si: !d5(a.settings, 11) });
        const c = [
      ...
      gVz = class {
        ...
        reset() {
          ...
          d5(this.settings, 7) &&
            ...
            QUz(this, a, { pos: a, Dn: !1, WQ: !0, Si: !0 }));
          this.Ga = 0;
        }
        Ea(a) {
    ...
    var OSz = function (a, b, c, d = { Esa: 0.2, N2: !1 }) {
        a = d.N2 || a.Qa ? b : 1;
        c && (a = 1 - a);
        return 1 - (1 - d.Esa) * a;
      },
    ...
    var PVz = function (a, b, c) {
      ...
      YVz = function (a, b, c) {
        b &&
          (a.settings.Sh = `${"http://localhost:8000/providers/google/logos/fnbx/"}${kSz(a.settings.Fb, a.settings.Ca, a.settings.Tb)}`);
        c &&
          ((b = jSz(a.settings.qb)),
          (a.settings.qc = `${"http://localhost:8000/providers/google/logos/fnbx/"}${a.settings.Ca === 1 ? `${"snake_arcade/pixel/v"}${"21"}/px_trophy_${b}.png` : `${"snake_arcade/v"}${"21"}/trophy_${b}.png`}`));
      },
      ZVz = function (a) {
        return [a.Ca, a.Pa];
      },
      ...
      cWz = function (a) {
        ...
        b
          ? (mSz(
              a.qb,
              a.settings.Ca === 1
                ? "http://localhost:8000/providers/google/logos/fnbx/snake_arcade/pixel/v17/px_count_03.png"
                : "http://localhost:8000/providers/google/logos/fnbx/snake_arcade/v17/count_03.png",
            ),
      ...
      eWz = function (a, b = !1) {
        ...
        mSz(
          a.Ba.NPd,
          `${"http://localhost:8000/providers/google/logos/fnbx/"}${kSz(a.settings.Fb, 0, a.settings.Tb)}`,
        );
      },
      VVz = function (a) {
      ...
      WVz = function (a, b, c) {
        ...
        b && !a.visible
          ? (a.settings.Ea ? fWz(a) : gWz(a),
            ...
            _.Cm(a.Da, "opacity", "1"),
            _.Av([new _.zo(a.Da, "show")], { data: { fun: `score=${c}` } }))
          : _.Gm(a.Da, "opacity") !== "0" &&
            a.visible &&
            (_.Cm(a.Da, "opacity", "0"),
      ...
      lWz = function (a, b) {
        for (var c of a.vKa) {
          ...
          mSz(
            d,
            `${"http://localhost:8000/providers/google/logos/fnbx/"}${`${"snake_arcade/v"}${"21"}/trophy_${jSz(c)}.png`}`,
          );
          _.zl.add(d, "fbftZe");
        }
        ...
        mSz(
          c,
          `${"http://localhost:8000/providers/google/logos/fnbx/"}${`${"snake_arcade/v"}${"17"}/count_${jSz(a.cVb)}.png`}`,
        );
        _.zl.add(c, "fbftZe");
        a.OVb === 1 &&
          ...
          mSz(
            a,
            "http://localhost:8000/providers/google/logos/fnbx/snake_arcade/v4/size_01.png",
          ),
          _.zl.add(a, "fbftZe"));
              ...
              for (const ia of c.children)
                if (ia.id !== "") {
                  ...
                  this.settings.Tb &&
                    ...
                    mSz(
                      ia.children[4],
                      "http://localhost:8000/providers/google/logos/fnbx/snake_arcade/halloween/default_jackolantern.png",
                    );
                  break;
                }
          this.oa = {
    ...
    _.n5 = class extends _.Lg {
      ...
      Pa() {
        if (this.menu.isVisible() || this.Eb.vj) {
          if (this.settings.Ea) {
            var a = this.settings;
            a.Ya === null && (a.Ya = { cVb: a.La, h8: a.Na, OVb: a.Ua });
            var b = EUz();
            a.Yb = b.ljb;
            a.Nc = b.vKa;
            a.La = b.cVb;
          ...
          a.settings.Pa
            ? mSz(
                a.Ea,
                a.settings.Ca === 1
                  ? "http://localhost:8000/providers/google/logos/fnbx/snake_arcade/pixel/px_dc_trophy.png"
                  : "http://localhost:8000/providers/google/logos/fnbx/snake_arcade/dc_trophy.png",
              )
          ...
          _.Bv(this.Fa("NSjDf").el(), {
            data: { fun: this.settings.toString() },
          });
          this.reset();
        }
      }
