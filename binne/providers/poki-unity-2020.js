...
, function(n, e, t) {
    ...
    u.startsWith(f) && (u = "".concat(f, "cdn-cgi/image/quality=78,width=40,height=40,fit=cover,g=0.5x0.5,f=auto/").concat(u.substr(f.length))),
    d.src = u;
    var h = i("slideshow-top-container")
      , m = i("game-title");
    m.innerText = r.a.title;
    var p = i("progress-spinner");
    p.innerHTML = '<div class="bounce0"></div><div class="bounce1"></div><div class="bounce2">',
